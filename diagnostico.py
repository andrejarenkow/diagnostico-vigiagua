...
municipio = st.selectbox('Selecione o município', options=dados[dados['Regional de Saúde']==crs]['Município'].unique(), index=None, placeholder='Selecione uma município')
tipo_forma_abastecimento = st.selectbox('Selecione o tipo da forma de abastecimento', options=dados[dados['Município']==municipio]['Tipo da Forma de Abastecimento'].unique(), index=None, placeholder='Selecione um tipo de forma de abastecimento')
